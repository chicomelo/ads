...
class DUPX_WPConfig
{
    ...
    {
        return DUPX_Paramas_Manager::getInstance()->getValue(DUPX_Paramas_Manager::PARAM_PATH_NEW).'/wp-config.php';
    }
    ...
    {
        return DUPX_Orig_File_Manager::getInstance()->getEntryTargetPath('wpconfig', self::getWpConfigDeafultPath());
    }
