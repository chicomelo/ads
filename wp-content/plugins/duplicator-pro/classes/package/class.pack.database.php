...
class DUP_PRO_Database
{
    ...
    /**
     * Version of MySQL since when the user has to have PROCESS privilege to dump tablespaces
     */
    const MYSQL_NO_TABLESPACE_VERSION = '5.7.31';
    ...
    private function getMysqlDumpCmd($exePath, $extraFlags = array())
    {
        ...
        if (version_compare(DUP_PRO_DB::getVersion(), self::MYSQL_NO_TABLESPACE_VERSION,'>=')) {
            $cmd .= ' --no-tablespaces';
        }
