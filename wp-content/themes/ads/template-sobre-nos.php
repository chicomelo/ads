...
?>
    ...
    <div class="sobre-nos__wrapper">
                    ...
                    <div class="col-12 col-md-10 offset-md-1">
                        ...
                        <div class="video__wrapper">
                            ...
                            <div class="conteudo">
                                ...
                                <a href="https://www.youtube.com/watch?v=sbKOBTXJfcw&ab_channel=PositivoTecnologia" data-fancybox data-width="960" data-height="540" class="btn" title="Assistir">
                                    Assistir
        ...
        <section class="nossos-clientes">
            ...
            <div class="slider-nossos-clientes__wrapper">
                <div class="slider-nossos-clientes-1">
                    <div class="slider">
                        <div>
                            <picture>
                                <source media="(max-width: 799px)" srcset="<?php echo do_shortcode("[img-url]"); ?>nossos-clientes-img-1-mobile.png" />
                                <img class="img-fluid" src="<?php echo do_shortcode("[img-url]"); ?>nossos-clientes-img-1.png" alt="Nossos clientes" />
                            </picture>
                        </div>
                        <div>
                            <picture>
                ...
                <div class="slider-nossos-clientes-2" dir="rtl">
                    <div class="slider">
                        <div>
                            <picture>
                                <source media="(max-width: 799px)" srcset="<?php echo do_shortcode("[img-url]"); ?>nossos-clientes-img-2-mobile.png" />
                                <img class="img-fluid" src="<?php echo do_shortcode("[img-url]"); ?>nossos-clientes-img-2.png" alt="Nossos clientes" />
                            </picture>
                        </div>
                        <div>
                            <picture>
                ...
                <div class="slider-nossos-clientes-3">
                    <div class="slider">
                        <div>
                            <picture>
                                <source media="(max-width: 799px)" srcset="<?php echo do_shortcode("[img-url]"); ?>nossos-clientes-img-3-mobile.png" />
                                <img class="img-fluid" src="<?php echo do_shortcode("[img-url]"); ?>nossos-clientes-img-3.png" alt="Nossos clientes" />
                            </picture>
                        </div>
                        <div>
                            <picture>
